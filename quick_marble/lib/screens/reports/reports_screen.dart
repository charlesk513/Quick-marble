  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text('Business Summary', style: Theme.of(context).textTheme.headlineSmall),
          const SizedBox(height: 12),
          _ReportRow(label: 'Clients', value: stats.clients.toString()),
          _ReportRow(label: 'Quotations', value: stats.quotations.toString()),
          _ReportRow(label: 'Pending quotations', value: stats.pendingQuotations.toString()),
          _ReportRow(label: 'Approved quotations', value: stats.approvedQuotations.toString()),
          _ReportRow(label: 'Contracts', value: stats.contracts.toString()),
          _ReportRow(label: 'Completed contracts', value: stats.completedContracts.toString()),
          _MoneyReportRow(label: 'Quotation value', amount: stats.quotationValue),
...
class _MoneyReportRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      child: ListTile(title: Text(label), trailing: MoneyText(amount, style: const TextStyle(fontWeight: FontWeight.bold))),
    );
  }
}
